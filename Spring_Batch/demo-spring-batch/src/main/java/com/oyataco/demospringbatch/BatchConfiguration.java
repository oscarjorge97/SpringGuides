package com.oyataco.demospringbatch;


import com.oyataco.demospringbatch.listener.JobListener;
import com.oyataco.demospringbatch.model.Persona;
import com.oyataco.demospringbatch.proccesor.PersonaItemProcessor;
...
public class BatchConfiguration {
    ...
    public FlatFileItemReader<Persona> reader(){
        return new FlatFileItemReaderBuilder<Persona>()
                ...
                .fieldSetMapper(new BeanWrapperFieldSetMapper<Persona>(){{setTargetType(Persona.class);}})
                .build();
    }
